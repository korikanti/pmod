    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/img1.jpg" width="196" height="326" alt="" class="fl" /></div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="p_EndUsers.jsp">View End Users </a></li>
			<li><a href="p_DataOwners.jsp">View Data Providers </a></li>
            <li><a href="p_ViewFiles.jsp">View Patient Reports </a></li>
			<li><a href="p_ViewAttackers.jsp">Patient Report Attackers </a></li>
            <li><a href="p_Transactions.jsp">View All Patient Report Transactions</a></li>
