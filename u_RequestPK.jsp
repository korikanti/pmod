    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <div class="article">
            <form action="u_RequestPK1.jsp" method="post" id="leavereply">
              <div align="center">
                <p align="left" class="style17">&nbsp;</p>
                <p align="left" class="style17">Enter Data Owner Name :&nbsp;
                  <input name="t142" type="text" size="30" />
                </p>
                <p align="left" class="style17"> Enter Report Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="t14" type="text" size="30" />
                </p>
                <p align="left" class="style17"><br />
                    <br />
                    <input type="submit" name="Submit" value="Request Private Key" /></p>
                <p align="left" class="style17">&nbsp;</p>
                <p align="right" class="style17"><a href="u_UserMain.jsp">Back</a></p>
              </div>
